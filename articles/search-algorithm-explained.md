...
| 変数選択（降下の駆動） | VSIDS / MRV / dom-wdeg を固定 or 静的混合 | activity（降下の大半を駆動。傾向制御全停止 +21【主証拠②】、temporal を外すと +81【主証拠①】＝真の主役。差分 +21 は temporal にマスクされた見かけ）+ **混合比をバンディットで学習**（mix_p、方向性） |
