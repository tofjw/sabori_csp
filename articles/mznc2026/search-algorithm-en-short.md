...
Code: <https://github.com/tofjw/sabori_csp>. FlatZinc-compliant. In the MiniZinc Challenge 2026 it placed 9th of 26 entries by free-category aggregate, directly below the native-CDCL solver pumpkin — even on solution quality, behind on proofs, with two problems a total wipeout. Per-problem breakdown: [challenge-2026-results-en.md](challenge-2026-results-en.md). None of the individual parts are new — the full write-up cites the prior work (Last Conflict, bandit-based variable selection, activity's implicit capture of structure, etc.). If I've overlooked a relevant reference, please point me to it.
