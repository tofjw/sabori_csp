...
def generate_html(results, problems, output_path=None, prob_types=None, data_labels=None, prob_years=None):
    ...
    if output_path is None:
        ...
        output_path = f"sabori_benchmark_alldiff_{ts}.html"
...
<head>
    <meta charset="UTF-8">
    <title>Sabori vs CP-SAT: all_different Problems</title>
    <style>
        body {{
...
<body>
    <h1>Sabori vs CP-SAT: all_different Problems</h1>
    <div class="meta">
