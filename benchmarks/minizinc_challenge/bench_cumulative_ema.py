...
<head>
    <meta charset="UTF-8">
    <title>Gradient EMA A/B Test</title>
    <style>
...
<body>
    <h1>Gradient EMA A/B Test (cumulative problems)</h1>
    <div class="meta">
        Generated: {now} | Timeout: {TIMEOUT}s | Problems: {len(problems)}<br>
        <b>EMA</b>: gradient EMA variable selection enabled |
        <b>NoEMA</b>: gradient EMA disabled
    </div>
    <div class="summary">
        <div class="stat-card">
...
def main():
    ...
    output_path = str(BASE_DIR / f"sabori_benchmark_cumulative_ema_{ts}.html")
